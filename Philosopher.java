...
public class Philosopher extends Thread {
	...
	//========= code that i implemented ( some help taken from lecture notes ) =================
	// ========================== 		START		================================
	...
	public void run() {
		...
		int waitingTime = new Random().nextInt(1000);
		// THE CODE BELOW CONDUCTING THE BARRIERS FOR PHILOSOPHERS FOR TIME THAT THEY COME
		try
		{
		...
		// THE MAIN PART THAT INDICATES THE STATES
		while(true)
		{
			think(id);
			takeForks(id);
